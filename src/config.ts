export const config = {
  ...
  corsOrigin: process.env.CORS_ORIGIN
    ...
    : ['http://localhost:5173', 'https://api.parties247.co.il', 'https://api.parties247.co.il/', 'https://whatsapp-crm-frontend-plum.vercel.app', 'https://parties247.co.il', 'https://parties247.co.il/'],
